...
<head>
    ...
    <script language="javascript">
        function _query(){
            ...
            myListGrid.query(document.getElementById('mainForm'),{startIndex:0,sizePerPage:100});
        }
...
<form id="mainForm" name="mainForm" method="post">
    ...
    <tr>
        ...
        <td>
        车次类型：<input name="trainTypeCheck" type="checkbox" value="query:type:G" onclick="setValue()" />高铁
                  <input name="trainTypeCheck" type="checkbox" value="query:type:C" onclick="setValue()" />城际
                  <input name="trainTypeCheck" type="checkbox" value="query:type:D" onclick="setValue()" />动车
                  <input name="trainTypeCheck" type="checkbox" value="query:type:Z" onclick="setValue()" />直达
                  <input name="trainTypeCheck" type="checkbox" value="query:type:T" onclick="setValue()" />特快
                  <input name="trainTypeCheck" type="checkbox" value="query:type:K" onclick="setValue()" />快速
            <input type="hidden" id="trainType" name="trainType" />
        </td>
        <td>
        发车时间：<select id="beginTime" name="beginTime">
                    <option value="">00:00-24:00</option>
                    <option value="query:time1">00:00-06:00</option>
                    <option value="query:time2">06:00-12:00</option>
                    <option value="query:time3">12:00-18:00</option>
                    <option value="query:time4">18:00-24:00</option>
                  </select>
        </td>
        <td>
